...
class CompletedPropertyDetailsScreen extends StatelessWidget {
  final bool isCompleted;
  const CompletedPropertyDetailsScreen({super.key, required this.isCompleted});
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _billRow(
                              AppLanguage.grandTotalText[language], "200 KWD",
                              isBold: true),
                        ],
                      ),
                    ),
