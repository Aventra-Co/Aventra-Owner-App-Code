...
class AddPropertyAdSecondScreen extends StatefulWidget {
  static String routeName = './AddPropertyAdSecondScreen';
  ...
  const AddPropertyAdSecondScreen({
    super.key,
    this.coverImage,
  ...
  @override
  State<AddPropertyAdSecondScreen> createState() =>
      _AddPropertyAdSecondScreenState();
}

class _AddPropertyAdSecondScreenState extends State<AddPropertyAdSecondScreen> {
  ...
  addAdvertisementApiCall() async {
    ...
    Uri url =
        Uri.parse("${AppConfigProvider.apiUrl}add_advertisement_property");
...
class CustomTextFormFieldSmallBox extends StatelessWidget {
  ...
  const CustomTextFormFieldSmallBox(
      {super.key,
