...
// class PropertyRatingDetailsScreen extends StatefulWidget {
//   static String routeName = './PropertyRatingDetailsScreen';
//   final String ratingId;
//   const PropertyRatingDetailsScreen({super.key, required this.ratingId});

//   @override
//   State<PropertyRatingDetailsScreen> createState() => _PropertyRatingDetailsScreenState();
// }

// class _PropertyRatingDetailsScreenState extends State<PropertyRatingDetailsScreen> {
...
//   Map<String, dynamic> ratingDetail = {
//   "name": "Palm Resort",
//   "total_rating": 4.5,
//   "review": "Very clean property and excellent hospitality service.",
// };

// List<Map<String, dynamic>> propertyRatingBreakdown = [
//   {
//     "title": "Cleanliness",
//     "rating": 4.5,
//   },
...
//                                     100),
//                             RatingBarIndicator(
//                               rating: ratingDetail['total_rating']
...
//       propertyRatingBreakdown.length,
//       (index) {
//         return Column(
//           children: [
//             Row(
...
//               children: [
//                 Text(
//                   propertyRatingBreakdown[index]['title'],
//                   style: const TextStyle(
//                       fontFamily: AppFont.fontFamily,
//                       fontSize: 14,
//                       fontWeight: FontWeight.w500,
...
//                 ),
//                 RatingBarIndicator(
//                   rating: propertyRatingBreakdown[index]['rating'],
//                   itemCount: 5,
//                   itemSize: 20,
//                   unratedColor: AppColor.textColor,
//                   itemBuilder: (context, _) => const Icon(
