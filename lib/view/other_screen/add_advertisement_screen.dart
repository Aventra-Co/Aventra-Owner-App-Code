...
import 'addAdvertisementSecondScreen.dart';
import 'dart:ui' as ui;

class AddAdvertisementScreen extends StatefulWidget {
  static String routeName = './AddAdvertisementScreen';
...
class _EditProfileScreenScreenState extends State<AddAdvertisementScreen> {
...
//! ------------------------------FROM GALLERY------------------------//
  ...
  //!=============================GET boats DETAILS===================================//
  Future<void> getBoatApi(userId, userType) async {
    Uri url = Uri.parse(
...
//       return;
//     } else if (serverImageList.isEmpty) {
//       SnackBarToastMessage.showSnackBar(
...
//             context,
//             MaterialPageRoute(
//               builder: (context) => AddAdvertisementSecondScreen(
                          ...
                          SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                //     child: Text(
                                //       AppLanguage.validateText[language],
                                //       style: const TextStyle(
                                //           fontFamily: AppFont.fontFamily,
                                //           fontSize: 13,
