...
class UpcomingDetailsScreen extends StatefulWidget {
  static String routeName = "./UpcomingDetailsScreen";
  final String tripId;
  const UpcomingDetailsScreen({super.key, required this.tripId});

  @override
  State<UpcomingDetailsScreen> createState() => _DetailsScreen();
}

class _DetailsScreen extends State<UpcomingDetailsScreen> {
      ...
      if (response.statusCode == 200) {
        ...
        if (res['success'] == true) {
          ...
          if (tripDetails.isNotEmpty) {
            ...
            log("addCalendarDate$addCalendarDate");
